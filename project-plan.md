...
This project investigates the current state of AI-driven music mastering by conducting a rigorous blind comparison between professionally mastered tracks and AI-mastered equivalents. Through structured listening tests with diverse participant groups, the study aims to determine whether modern AI mastering tools have reached a level of quality that is perceptually comparable to human mastering engineers.

---

## Week 1: Research, Planning & Song Selection
...
## Week 2: Engage Professional Mastering Engineers

**Dates:** Week 2 of 8
**Phase:** Human Mastering
...
### Tasks
1. **Engineer Identification & Outreach**
   - Research and shortlist mastering engineers (ideally with varying levels of experience and studio setups)
...
2. **Brief Preparation & Delivery**
   - Prepare a standardised mastering brief for each song (target loudness, format requirements, any genre-specific notes)
...
## Week 3: AI Mastering & Preliminary Collection

**Dates:** Week 3 of 8
**Phase:** AI Mastering & Collection
...
### Tasks
1. **AI Mastering Execution**
   - Process each song through each selected AI mastering platform
   - For each platform, experiment with available settings (genre presets, loudness targets, tonal adjustments)
   - Select the best AI master from each platform for each song (or use default settings for consistency -- document your decision and rationale)
   - Export all AI masters in matching formats (16-bit/44.1kHz and 24-bit/48kHz WAV)

2. **Documentation of AI Process**
...
## Week 4: Collection, Normalisation & Test Preparation
...
2. **Audio Normalisation & Preparation**
   - Loudness-normalise all masters (human and AI) to a consistent level (e.g., -14 LUFS or -16 LUFS integrated)
   ...
   - Create a master reference document mapping labels to sources (keep this strictly confidential)

3. **Test Platform Setup**
   - Set up the listening test platform (consider: Google Forms + audio hosting, Qualtrics, dedicated AB testing tools like webMUSHRA, or a custom web app)
   - Upload all anonymised audio files
   - Create the questionnaire with scoring criteria
   - Include demographic questions (musical training, listening experience, age, etc.)

4. **Pilot Test**
   - Run a small pilot test (2-3 people) to validate the test flow
   - Check for technical issues (audio playback, form logic, timing)
   - Gather feedback on question clarity and test fatigue
...
## Week 5: Recruit Participants & Begin Blind Testing

**Dates:** Week 5 of 8
**Phase:** Testing (Part 1)
...
1. **Participant Recruitment**
   - Recruit participants from the following groups:
     - **MMT classmates** (trained ears, music technology background)
     - **Other music students** at TCD (performance, composition, musicology)
     - **Professional musicians/engineers** (external contacts)
     - **General listeners** (non-musicians for a broader perspective)
   - Aim for a minimum of 20-30 participants across groups
   - Distribute consent forms and collect signed agreements

2. **Listening Test Sessions**
   - Schedule and conduct listening test sessions
   - Provide consistent listening conditions where possible (same headphones/speakers, quiet environment)
...
## Week 6: Complete Testing & Begin Analysis

**Dates:** Week 6 of 8
**Phase:** Testing (Part 2) & Early Analysis
...
## Week 7: Deep Analysis & Thesis Writing
...
1. **Comprehensive Analysis**
   - Perform detailed statistical analysis across all dimensions:
...
2. **Spectral & Technical Analysis (Optional Enhancement)**
...
## Week 8: Conclusions, Final Write-Up & Presentation
...
1. **Conclusions & Discussion**
   ...
   - Address any unexpected findings or anomalies

2. **Complete Thesis Document**
...
4. **Submission**
   ...
   - Submit thesis and supporting materials
...
| Technical issues with test platform | Delays testing | Pilot test in Week 4; have offline backup (USB + paper forms) |
| Ethics approval delays | Blocks testing | Submit ethics application in Week 1 |

---

## Tools & Resources

### AI Mastering Platforms (Candidates)
- LANDR (landr.com)
...
| 2 | Human Mastering | Engage engineers, begin AI research |
| 3 | AI Mastering | Process AI masters, design blind test |
| 4 | Test Prep | Normalise audio, build test platform, pilot |
| 5 | Testing (1) | Recruit participants, begin blind tests |
| 6 | Testing (2) | Complete tests, preliminary analysis |
| 7 | Analysis | Deep analysis, begin thesis writing |
| 8 | Completion | Conclusions, final write-up, presentation |
